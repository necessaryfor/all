...
//Application Title
define('APP_TITLE', 'Elmar File Manager');
...
// Generate secure password hash - https://lordfilemanager.github.io/docs/pwd.html
$auth_users = array(
    'Elmar' => '$2y$10$pXatyDxLLAN5sj.JYAGMIezxihUEOdgySFkPNrJLjGOtKOj1Z3Wqi'
);
...
// sample config - https://lordfilemanager.github.io/config-sample.txt
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K lord File Manager">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://lordfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/lordfilemanager" target="_blank" class="app-v-title"> lord File Manager <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/prasathmani/lordfilemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/prasathmani/lordfilemanager/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
if (isset($_GET['edit']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        if ($is_text && $isNormalEditor) {
            ...
            echo '<div id="editor" contenteditable="true"><textarea style="display:none">' . htmlspecialchars($content) . '</textarea></div>';
        } else {
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://lordfilemanager.github.io" target="_blank" class="float-right text-muted">lord File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://lordfilemanager.github.io" target="_blank" class="float-right text-muted">lord File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'lord File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with lord File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'lord File Manager';      $tr['en']['AppTitle']           = 'File Manager';
